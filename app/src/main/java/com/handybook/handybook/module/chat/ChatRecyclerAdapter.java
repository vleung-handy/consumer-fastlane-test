...
public class ChatRecyclerAdapter extends RecyclerView.Adapter<ChatViewHolder> {
    ...
    public ChatViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ChatItem.Type.MESSAGE.ordinal()) {
            layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fire_base_chat_list_item, parent, false);
        } else if (viewType == ChatItem.Type.TITLE.ordinal()) {
            layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fire_base_chat_list_header, parent, false);
        } else if (viewType == ChatItem.Type.DATE_DIVIDER.ordinal()) {
            layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fire_base_chat_list_divider, parent, false);
        } else if (viewType == ChatItem.Type.IMAGE.ordinal()) {
            layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fire_base_chat_image, parent, false);
        }
