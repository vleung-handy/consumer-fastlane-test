...
public class LayerConversationActivity extends LayerBaseActivity implements RecyclerViewController.Callback {
    ...
    public void onQueryDataSetChanged(RecyclerViewController recyclerViewController) {
        ...
        if (mQueryController.getItemCount() == 0) {
            Snackbar.make(mMainLayout, "There are NO existing conversations", Snackbar.LENGTH_SHORT).show();
            return;
        }
    ...
    public void onQueryItemChanged(RecyclerViewController recyclerViewController, int i) {
        Log.d(TAG, "onQueryItemChanged() called with: recyclerViewController = [" + recyclerViewController + "], i = [" + i + "]");
    }

    @Override
    public void onQueryItemRangeChanged(RecyclerViewController recyclerViewController, int i, int i1) {
        Log.d(TAG, "onQueryItemRangeChanged() called with: recyclerViewController = [" + recyclerViewController + "], i = [" + i + "], i1 = [" + i1 + "]");
    }

    @Override
    public void onQueryItemInserted(RecyclerViewController recyclerViewController, int position) {
        Log.d(TAG, "onQueryItemInserted() called with: recyclerViewController = [" + recyclerViewController + "], i = [" + position + "]");
    ...
    public void onQueryItemRangeInserted(RecyclerViewController recyclerViewController, int i, int i1) {
        Log.d(TAG, "onQueryItemRangeInserted() called with: recyclerViewController = [" + recyclerViewController + "], i = [" + i + "], i1 = [" + i1 + "]");
    }

    @Override
    public void onQueryItemRemoved(RecyclerViewController recyclerViewController, int i) {
        Log.d(TAG, "onQueryItemRemoved() called with: recyclerViewController = [" + recyclerViewController + "], i = [" + i + "]");
    }

    @Override
    public void onQueryItemRangeRemoved(RecyclerViewController recyclerViewController, int i, int i1) {
        Log.d(TAG, "onQueryItemRangeRemoved() called with: recyclerViewController = [" + recyclerViewController + "], i = [" + i + "], i1 = [" + i1 + "]");
    }

    @Override
    public void onQueryItemMoved(RecyclerViewController recyclerViewController, int i, int i1) {
        Log.d(TAG, "onQueryItemMoved() called with: recyclerViewController = [" + recyclerViewController + "], i = [" + i + "], i1 = [" + i1 + "]");
    }
}
