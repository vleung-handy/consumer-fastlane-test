...
public class BookingFunnelLog extends EventLog {
    ...
    protected BookingFunnelLog(
            final String eventType,
            @UserLoginLog.AuthType final String authType
    ) {
        this(eventType);
        mAuthType = authType;
    }
    ...
    public static class BookingOneTimeTrialCtaTappedLog extends BookingFunnelLog {
        ...
        private static final String EVENT_TYPE = "onetime_trial_cta_tapped";
    ...
    public static class BookingRequestMadeLog extends BookingFunnelLog {
        ...
        public BookingRequestMadeLog(
            ...
            mIsDynamicPriceShown = bookingQuote.getPeakPriceTable() != null &&
                                   bookingQuote.getPeakPriceTable()
                                               .size() > 0;
