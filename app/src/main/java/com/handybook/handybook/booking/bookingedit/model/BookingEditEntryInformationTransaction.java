...
public final class BookingEditEntryInformationTransaction {
    ...
    public BookingEditEntryInformationTransaction(List<BookingInstruction> entryInstructions, boolean applyToAllInSeries)
    {
