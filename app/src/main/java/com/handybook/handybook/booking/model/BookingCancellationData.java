...
public class BookingCancellationData implements Serializable
{
    ...
    private static class CancellationInfo implements Serializable
    {
    ...
    private static class PreCancellationInfo implements Serializable
    {
        @SerializedName("title")
        private String mTitle;
    ...
    private static class CancellationReason implements Serializable
    {
        @SerializedName("id")
        private Integer mId;
