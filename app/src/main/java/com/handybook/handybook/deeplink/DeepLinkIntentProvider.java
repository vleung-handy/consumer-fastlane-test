...
public class DeepLinkIntentProvider {
    ...
    @DeepLink({
                      DEEP_LINK_SIDE_MENU_URL + "mybookings",
    ...
    @DeepLink({
                      DEEP_LINK_SIDE_MENU_URL + "past_bookings",
    ...
    @DeepLink({
                      DEEP_LINK_SIDE_MENU_URL + "mybookings/id/{" + BundleKeys.BOOKING_ID + "}",
    ...
    @DeepLink({
                      DEEP_LINK_SIDE_MENU_URL + "account",
    ...
    private static Intent createBottomNavActivityIntent(
            @NonNull Context context,
            @Nullable MainNavTab mainNavTab
    ) {
     ...
     * @return
     */
    private static Intent createBottomNavLoginActivityIntent(
            @NonNull Context context,
            @Nullable MainNavTab mainNavTab
    ) {
