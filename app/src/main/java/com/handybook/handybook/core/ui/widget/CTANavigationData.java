...
public final class CTANavigationData {
    ...
    //TODO: May remove this from the class and have relevant requestors go through the service for their login tokens
    ...
    public CTANavigationData(
            String navigationActionId,
            String nodeContentWebUrl,
            String loginToken
    ) {
