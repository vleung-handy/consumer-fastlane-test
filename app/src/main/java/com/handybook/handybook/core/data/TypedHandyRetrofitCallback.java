...
class BookingOptionsWrapperHandyRetroFitCallback
        extends TypedHandyRetrofitCallback<BookingOptionsWrapper> {
...
class HelpNodeWrapperResponseHandyRetroFitCallback
        extends TypedHandyRetrofitCallback<HelpNodeWrapper> {
...
class BookingRequestableProsResponseHandyRetroFitCallback
        extends TypedHandyRetrofitCallback<BookingRequestablePros> {
...
class BookingProRequestResponseHandyRetroFitCallback
        extends TypedHandyRetrofitCallback<BookingProRequestResponse> {
...
class UserBookingsWrapperHandyRetroFitCallback
        extends TypedHandyRetrofitCallback<UserBookingsWrapper> {
...
class BookingPricesForFrequenciesHandyRetroFitCallback
        extends TypedHandyRetrofitCallback<BookingEditFrequencyInfoResponse> {
...
class EditExtrasInfoHandyRetroFitCallback
        extends TypedHandyRetrofitCallback<BookingEditExtrasInfoResponse> {
...
class EditHoursInfoHandyRetroFitCallback
        extends TypedHandyRetrofitCallback<BookingEditHoursInfoResponse> {
