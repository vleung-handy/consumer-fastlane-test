...
public class HelpNativeFragment extends InjectedFragment
{
    ...
    public static HelpNativeFragment newInstance(final String bookingId,
    ...
    {
        final HelpNativeFragment fragment = new HelpNativeFragment();
    ...
    {
        final Intent intent = new Intent(getActivity(), HelpNativeActivity.class);
