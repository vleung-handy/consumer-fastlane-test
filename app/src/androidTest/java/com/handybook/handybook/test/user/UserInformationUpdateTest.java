...
public class UserInformationUpdateTest
{
    ...
    private static final String NEW_NAME = "testlogin user";
    private static final String NEW_EMAIL = "testlogin@user.com";
    ...
    public void testUpdateInformation()
    {
        ...
        ViewUtil.waitForViewVisible(android.R.id.progress, ViewUtil.LONG_MAX_WAIT_TIME_MS); // wait for loading progress dialog
        ViewUtil.waitForViewVisible(R.id.profile_fullname_text, ViewUtil.LONG_MAX_WAIT_TIME_MS);
        DrawerActions.openDrawer(R.id.drawer_layout);
