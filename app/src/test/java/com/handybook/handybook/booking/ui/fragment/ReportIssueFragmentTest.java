...
public class ReportIssueFragmentTest extends RobolectricGradleTestWrapper {
    ...
    public void shouldHaveCorrectTitleAndHeader() {
        ...
        assertEquals(
                fragment.getString(R.string.booking_number, mBooking.getId()),
        ...
        TextView providerText = (TextView) fragment.getView()
                                                   .findViewById(R.id.report_issue_provider);
    ...
    public void shouldShowMilestones() {
        ...
        milestones[0] = new JobStatus.Milestone(
                "On their way",
                "Your pro, John, is on his way",
                JobStatus.Milestone.NORMAL,
                actions,
                new Date()
        );
        milestones[1] = new JobStatus.Milestone(
                "warning",
                "warning",
                JobStatus.Milestone.WARNING,
                null,
                new Date()
        );
        milestones[2] = new JobStatus.Milestone(
                "error",
                "error",
                JobStatus.Milestone.ERROR,
                null,
                new Date()
        );
        milestones[3] = new JobStatus.Milestone(
                "invalid",
                "invalid",
                JobStatus.Milestone.INVALID,
                null,
                new Date()
        );
        ...
        assertEquals(
                View.VISIBLE,
                milestoneView.findViewById(R.id.pro_milestone_call).getVisibility()
        );
        assertEquals(
                View.VISIBLE,
                milestoneView.findViewById(R.id.pro_milestone_text).getVisibility()
        );
