...
public class BookingEditFrequencyFragmentTest extends RobolectricGradleTestWrapper {
    ...
    public void shouldRequestEditFrequencyViewModelOnCreateView() throws Exception {
        AppAssertionUtils.assertBusPost(
                mFragment.bus,
                mCaptor,
                instanceOf(BookingEditEvent.RequestGetEditFrequencyViewModel.class)
        );
    }
    ...
    public void shouldRequestEditFrequencyWhenSubmitButtonPressed() throws Exception {
        ...
        mFragment.onReceiveEditFrequencyViewModelSuccess(new BookingEditEvent.ReceiveGetEditFrequencyViewModelSuccess(
                editFrequencyViewModel));
        mFragment.mSaveButton.performClick();
        AppAssertionUtils.assertBusPost(
                mFragment.bus,
                mCaptor,
                instanceOf(BookingEditEvent.RequestEditBookingFrequency.class)
        );
    }
    ...
    public void shouldShowErrorToastWhenServerError() throws Exception {
        ...
        mFragment.onReceiveUpdateBookingFrequencyError(new BookingEditEvent.ReceiveEditBookingFrequencyError(
